        ...
        <div className="xl:w-[800px] min-[768px]:w-[700px] w-[380px]  mr-auto ml-auto">
          ...
          <div className="content rounded-[20px] mt-[50px] border-[1px] border-[#D5D5D5] p-10 flex flex-col gap-[20px]">
            ...
            <p>
              ...
              phẩm mới Mac của Apple đã chính thức ra mắt, tạo một làn sóng gây
            ...
            <p>
              Sản phẩm MacBook Pro mới ra mắt bao gồm 2 phiên bản MacBook Pro M3
              14 inch và MacBook Pro M3 16 inch với một số tính năng và cải tiến
              xuất sắc.
            </p>
            <p>
              Cả hai mẫu MacBook Pro này đều được trang bị chip M3 mới nhất của
              Apple, mang đến hiệu năng mạnh mẽ và khả năng tiết kiệm năng lượng
              vượt trội.
            </p>
            <h1 className="text-xl font-semibold">Thiết kế</h1>
            <p>
              Thiết kế mới sang trọng. với vỏ nhôm nguyên khối, với các góc cạnh
              được bo tròn. Máy có hai màu sắc chính là bạc và xám than.
            </p>
            ...
            <p>
              ...
              Cả hai kích thước màn hình đều sử dụng tấm nền Liquid Retina XDR,
              với độ phân giải 3024 x 1964 pixel và tần số quét 120Hz. Màn hình
              Liquid Retina XDR tối ưu những vùng sáng, kể cả hình ảnh vùng tối
              vẫn chi tiết, sắc nét, độ tương phản cao và màu sắc chính xác.
            </p>
            <p>
              Đặc biệt, với tần số quét 120Hz hình ảnh hiển thị mượt mà và trơn
              tru hơn. Đặc biệt mãn nhãn khi chơi trò chơi điện tử đồ họa đẹp
              mắt, hay và xem video chất lượng.
            </p>
            <h1 className="text-xl font-semibold">Chip</h1>
            <p>
              Chip M3, M3 Pro và M3 Max đều là con chip mới nhất của Apple, được
              sản xuất trên tiến trình 3nm. Chip M3 là dòng chip tiên tiến nhất
              từng được thiết kế cho máy tính cá nhân, hơn hết, hiệu năng CPU và
              GPU mạnh mẽ hơn so với chip M2.
            </p>
            ...
            <p>
              ...
              khung hình khi họ di chuyển. Song song hệ thống loa 6 loa, với âm
              thanh nổi Dolby Atmos truyền tải âm thanh sống động và mạnh mẽ,
            </p>
            <h1 className="text-xl font-semibold">Bàn phím và Touch Bar</h1>
            <p>
              Bàn phím được thiết kế với các phím bấm có độ nảy tốt và độ chính
              xác cao. Touch Bar nhạy, gần như không có độ trễ, dễ dàng thao tác
              điều khiển máy.
            </p>
            <h1 className="text-xl font-semibold">Cổng kết nối</h1>
            <p>
              MacBook Pro M3 có ba cổng Thunderbolt 4, một cổng HDMI và một cổng
              MagSafe 3.
            </p>
            ...
            <p>
              MacBook Pro giờ đây được trang bị công nghệ dò tia tốc độ cao bằng
              phần cứng, mang đến hiệu năng kết xuất nhanh hơn đến 2,5 giờ và
              giúp các ứng dụng chuyên nghiệp và trò chơi hiển thị chân thực hơn
              bao giờ hết.
            </p>
