      ...
      {props.mobile ? (
        <div className="item flex justify-between pb-10 items-center">
          <div className="item_left">
            <div className="image flex items-center w-[70px] h-auto relative">
              <Image fill src={props.ele.thumbnail} alt="image_item" />
            </div>
          </div>
        ...
        <>
          <div className="item flex">
            <div className="info_item w-[40%] flex gap-[15px] items-center">
              <div className="image flex items-center w-[70px] h-[90px] relative">
                <Image fill src={props.ele.thumbnail} alt="image_item" />
              </div>
              <div className="info_product flex flex-col gap-[10px]">
                <div className="name">
